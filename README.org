...
[[file:trips.csv]] has one line per trip outside of Canada.

[[file:trips.R]] uses R data.table IDate and non-equi join to compute a
...
The output of the script is an output such as: 1096.5 days in Canada
between 2024-05-30 and 2028-03-01 whereas min number required for
citizenship is 1095.
